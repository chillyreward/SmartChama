    ...
    <div className="p-6 max-w-[1280px] mx-auto w-full font-inter space-y-8 pb-20">
      ...
      <div>
        <h1 className="text-headline-lg font-geist font-bold text-on-surface flex items-center gap-3">
          My Chamas 
          <span className="text-xs bg-surface-container-low text-secondary px-2 py-1 rounded-full border border-[#E5E7EB]">
            {chamas.length} Active
          </span>
        </h1>
        <p className="text-secondary mt-1">Manage your investment groups and track performance</p>
      </div>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="bg-surface-container-lowest px-3 py-1 rounded-full border border-[#E5E7EB] flex items-center gap-2">
                      <Lock className="w-3 h-3 text-secondary" />
                      <span className="text-[10px] font-bold text-secondary uppercase tracking-wider">Encrypted</span>
                    </div>
                  </div>

                  <h3 className="text-headline-sm font-geist font-bold text-on-surface mb-1">{chama.name}</h3>
                  <p className="text-sm text-secondary mb-6">Admin • {chamaMemberCounts[chama.id] || 0} members</p>

                  <div className="flex justify-between items-end border-t border-[#E5E7EB] pt-4">
                    <div>
                      <p className="text-[10px] text-secondary uppercase font-bold">Total Balance</p>
      ...
      {!loadingChamas && chamas.length === 0 && (
        <div className="text-center py-12 text-secondary">
          ...
          <p className="text-lg font-bold text-secondary mb-2">No chamas yet</p>
      ...
      {/* CREATE CHAMA MODAL */}
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0B0F0C]/80 backdrop-blur-md p-4">
          <div className="bg-white border border-[#E5E7EB] w-full max-w-md rounded-[32px] p-8 relative shadow-2xl">
            
            <button 
              onClick={() => setShowCreateModal(false)}
              className="absolute top-4 right-4 text-secondary hover:text-on-surface bg-surface-container-low rounded-full p-2 transition-colors"
            >
              <X className="w-4 h-4" />
            </button>
                ...
                <div className="space-y-3">
                  {chamaRules.map((rule, index) => (
                    <div key={index} className="flex gap-2">
                      <div className="flex-shrink-0 w-6 h-10 flex items-center justify-center text-secondary font-bold text-sm">
                        {index + 1}.
                      </div>
                      <input
                        type="text"
                      ...
                      {chamaRules.length > 1 && (
                        <button
                          ...
                          className="flex-shrink-0 w-10 h-10 flex items-center justify-center text-secondary hover:text-red-400 hover:bg-red-500/10 rounded-xl transition-all"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      )}
      ...
      {selectedGroup && !showDetailsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0B0F0C]/80 backdrop-blur-md p-4">
          <div className="bg-white border border-[#E5E7EB] w-full max-w-md rounded-[32px] p-8 relative shadow-2xl text-center">
            
            <button 
              onClick={() => setSelectedGroup(null)}
              className="absolute top-6 right-6 text-secondary hover:text-on-surface"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            {step === 1 && (
              <div>
                ...
                <p className="text-secondary text-sm mb-8">
                  ...
                  <span className="text-on-surface font-bold">{selectedGroup.name}</span>
                </p>
                ...
                <p className="text-xs text-secondary">Enter any 4 digits (Demo Mode)</p>
              </div>
            )}
      ...
      {/* CHAMA DETAILS MODAL */}
      {selectedGroup && showDetailsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0B0F0C]/80 backdrop-blur-md p-4 overflow-y-auto">
          <div className="bg-white border border-[#E5E7EB] w-full max-w-4xl rounded-[32px] p-8 relative shadow-2xl my-8">
            ...
            <button 
              ...
              className="absolute top-6 right-6 text-secondary hover:text-on-surface bg-surface-container-low rounded-full p-2 transition-colors z-10"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <div className="mb-8">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-secondary">Chama Overview & Management</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <div className="bg-surface-container-lowest border border-[#E5E7EB] rounded-2xl p-6">
                <p className="text-xs text-secondary uppercase font-bold mb-2">Total Balance</p>
              ...
              <div className="bg-surface-container-lowest border border-[#E5E7EB] rounded-2xl p-6">
                <p className="text-xs text-secondary uppercase font-bold mb-2">Investment Goal</p>
                <p className="text-3xl font-bold text-on-surface mb-1">
              ...
              <div className="bg-surface-container-lowest border border-[#E5E7EB] rounded-2xl p-6">
                <p className="text-xs text-secondary uppercase font-bold mb-2">Monthly Growth</p>
                <p className="text-3xl font-bold text-on-surface mb-1">
                  {parseFloat(selectedGroup.monthly_growth_pct || 0).toFixed(1)}%
                </p>
                <p className="text-xs text-secondary">Target rate</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-surface-container-lowest border border-[#E5E7EB] rounded-2xl p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-secondary mb-1">Created</p>
                  ...
                  <div>
                    ...
                    <p className="text-on-surface font-semibold">{chamaMemberCounts[selectedGroup.id] || 0} members</p>
                  </div>
                  <div>
              ...
              <div className="bg-surface-container-lowest border border-[#E5E7EB] rounded-2xl p-6">
                ...
                {loadingTransactions ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-secondary text-xs mt-1">Transactions will appear here once members start contributing</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                        ...
                        <div key={txn.id} className="p-4 bg-white rounded-xl border border-[#E5E7EB] hover:border-[#E5E7EB] transition-all">
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className="text-on-surface font-semibold text-sm capitalize">{txn.transaction_type}</p>
                                <p className="text-secondary text-xs">{new Date(txn.created_at).toLocaleDateString()}</p>
                              </div>
                            </div>
              ...
              <div className="bg-white border border-purple-500/30 rounded-2xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-surface-container-lowest/50 border border-[#E5E7EB] rounded-xl p-4 mb-4">
                      <h4 className="text-on-surface font-semibold text-sm mb-3">Pay-as-you-go Pricing:</h4>
      ...
      {showInviteModal && inviteChama && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-[#0B0F0C]/80 backdrop-blur-md p-4">
          <div className="bg-white border border-[#E5E7EB] w-full max-w-md rounded-[32px] p-8 relative shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-secondary text-sm">
                Share this link to invite members to <span className="text-on-surface font-bold">{inviteChama.name}</span>
              </p>
            </div>
            ...
            {generatingInvite ? (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-surface-container-low border border-[#E5E7EB] rounded-xl p-4">
