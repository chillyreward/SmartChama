  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-white flex items-center gap-2">
            SmartGrow <span className="bg-amber-500 text-black text-xs px-2 py-0.5 rounded uppercase font-bold tracking-wider">Admin</span>
          </h1>
          <p className="text-slate-400 mt-1">Institutional-grade investments for your Chamas.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-amber-900/40 to-slate-900 border border-amber-500/20 rounded-3xl p-6">
          <p className="text-amber-400 text-xs font-bold uppercase tracking-widest mb-2">Total Chama Investments</p>
          <h3 className="text-4xl font-black text-white">KES 0</h3>
          <p className="text-slate-400 text-sm mt-2 flex items-center gap-1">
            <TrendingUp className="w-4 h-4 text-amber-500" /> Recommend investments to members
          </p>
        </div>
        <div className="md:col-span-2 bg-slate-900 border border-slate-800 rounded-3xl p-6 flex flex-col justify-center">
           ...
           <div className="flex flex-wrap gap-4">
             {[
               ...
               <div key={i} className="px-6 py-3 bg-slate-950 border border-slate-800 rounded-xl text-slate-400 font-bold hover:border-amber-500/50 hover:text-white transition-all cursor-pointer flex items-center gap-2">
      ...
      <div>
        <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
          Verified Opportunities <Shield className="w-5 h-5 text-amber-500" />
        </h3>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {opportunities.map((item) => (
            <div key={item.id} className="group bg-slate-900 border border-slate-800 rounded-[32px] p-1 overflow-hidden hover:border-amber-500/50 transition-all">
              <div className="bg-slate-950 rounded-[28px] p-6 h-full flex flex-col justify-between relative overflow-hidden">
                ...
                <div>
                  ...
                  <h4 className="text-xl font-bold text-white mb-1 group-hover:text-amber-400 transition-colors">{item.title}</h4>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                 <div className="bg-slate-900/50 p-4 rounded-2xl border border-slate-800">
                    ...
                    <p className="text-xl font-bold text-amber-400">{selectedInvest.returnRate}</p>
                 </div>
                 <div className="bg-slate-900/50 p-4 rounded-2xl border border-slate-800">
              ...
              <div className="flex gap-4">
                ...
                <a 
                  ...
                  className="flex-[2] bg-amber-500 hover:bg-amber-400 text-black py-4 rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(245,158,11,0.3)]"
                >
