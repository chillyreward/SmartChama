  ...
  return (
    <div className="p-6 max-w-[1280px] mx-auto w-full font-inter space-y-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-headline-lg font-geist font-bold text-on-surface flex items-center gap-2">
            SmartGrow <span className="bg-[#22C55E] text-black text-xs px-2 py-0.5 rounded uppercase font-bold tracking-wider">Pro</span>
          </h1>
          <p className="text-secondary mt-1">Institutional-grade investments for your Chama.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-emerald-900/40 to-slate-900 border border-[#E5E7EB] rounded-3xl p-6">
          <p className="text-[#22C55E] text-xs font-bold uppercase tracking-widest mb-2">My Investment Portfolio</p>
          <h3 className="text-4xl font-black text-on-surface">KES 0</h3>
          <p className="text-secondary text-sm mt-2 flex items-center gap-1">
            <TrendingUp className="w-4 h-4 text-[#22C55E]" /> Start investing today
          </p>
        </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex gap-4">
                ...
                <a 
                  ...
                  className="flex-[2] bg-[#22C55E] hover:bg-[#006e2f] text-black py-4 rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(16,185,129,0.3)]"
                >
