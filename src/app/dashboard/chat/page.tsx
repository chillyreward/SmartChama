...
export default function ChatPage() {
  ...
  const handleSend = async () => {
    ...
    // 2. Simulate AI Thinking (We will connect Real AI later)
    setTimeout(() => {
      const aiMsg = { 
        role: "assistant", 
        content: "That is a great question about Chamas! I am currently running in Demo Mode, but once my brain (Gemini) is connected, I will answer that instantly." 
      };
